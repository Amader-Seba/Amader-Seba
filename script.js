// ==================== কনফিগ ====================
const API_URL = 'https://script.google.com/macros/s/AKfycbwoezFHtiw2GJKULgFjVrzOYsKrJctUM3s9euHbPAISHv5Rz5h8L3PrYgDNa4xck3t2/exec'; // আপনার URL বসান
...
function showOrderFormInline(serviceId) {
...
async function loadOrdersTable(serviceId) {
  ...
  orders.forEach((o, idx) => {
    ...
    html += `<tr><td>${idx+1}</td><td>${serviceForms[o.serviceId]?.name || o.serviceId}</td>
      ...
      <td>${messageHtml}${detailsBtn ? ' ' + detailsBtn : ''}</td></tr>`;
  });
  html += `</tbody></table>`;
